...
var Database = require("../../dist/database.js").Database;

// Create the database. Use { mock: true } option for testing
var dao = new Database('default', 'pouchdb', {});
...
describe('DAO', function(){
    ...
    describe('#new DAO', function(){
        it('should return a new DAO constructor object.', function(){
            expect(dao._adapter).to.equal('pouchdb');
            expect(dao._dbname).to.equal('default');
        });
    });
